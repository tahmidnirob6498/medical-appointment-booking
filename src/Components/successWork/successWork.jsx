...
const SuccessWork = () => {
    return (
       ...
       <div className='grid grid-cols-4 max-w-6/8 mx-auto gap-3 mt-5 py-3'>
<div className='flex flex-col gap-3 border border-black rounded-xl bg-base-100 items-center justify-center p-5'>
        <img src="../../../C001-assets/success-doctor.png" height={60} width={60} alt="" />
        <p className='text-5xl font-semibold'>199+</p>
        <p>Total Doctors</p>
        </div>  

        <div className='flex flex-col gap-3 border border-black rounded-xl bg-base-100 items-center justify-center p-5'>
        <img src="../../../C001-assets/success-doctor.png" height={60} width={60} alt="" />
        <p className='text-5xl font-semibold'>467+</p>
        <p>Total Doctors</p>
        </div>
